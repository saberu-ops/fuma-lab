...
> [查看官网](https://www.fumadocs.dev/docs/guides/access-control) · [查看源文件](https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/(framework)/guides/access-control.mdx)
...
If you are using [`loader()`](https://www.fumadocs.dev/docs/headless/source-api) API, you can create the loaders on-demand, and filter files from content source to restrict accessible content.
