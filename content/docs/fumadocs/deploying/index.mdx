...
> [查看官网](https://www.fumadocs.dev/docs/deploying) · [查看源文件](https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/(framework)/deploying/index.mdx)

Deploy your Fumadocs app
...
If you are looking to host the app as a SPA app (fully static, hostable on CDN), see [Static Build](/docs/fumadocs/deploying/static).

There's some extra notes on specific combinations:

### Next.js + Cloudflare [#nextjs--cloudflare]
