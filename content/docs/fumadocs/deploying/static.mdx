...
> [查看官网](https://www.fumadocs.dev/docs/deploying/static) · [查看源文件](https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/(framework)/deploying/static.mdx)
...
<div className="fd-steps">
  <div className="fd-step">
    ...
    1. [Configure Search Server](https://www.fumadocs.dev/docs/headless/search/orama#static-export).
    2. [Configure Search UI/Client](/docs/fumadocs/search/orama#static).
