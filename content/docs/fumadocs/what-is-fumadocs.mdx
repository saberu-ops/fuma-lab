...
> [查看官网](https://www.fumadocs.dev/docs/what-is-fumadocs) · [查看源文件](https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/(framework)/what-is-fumadocs.mdx)
...
Instead, we follow a much more flexible approach inspired by Shadcn UI — [Fumadocs CLI](https://www.fumadocs.dev/docs/cli), allowing you to "fork" a part of Fumadocs UI, and fully customize it.
...
You can read [Comparisons](https://www.fumadocs.dev/docs/comparisons) if you're interested.
