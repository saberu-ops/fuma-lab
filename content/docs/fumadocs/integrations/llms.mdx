...
> [查看官网](https://www.fumadocs.dev/docs/integrations/llms) · [查看源文件](https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/(framework)/integrations/llms.mdx)
...
<CodeBlockTabs defaultValue="Next.js">
  ...
  <CodeBlockTab value="Tanstack Start">
    ...
    ```ts  title="src/routes/docs/{$}[.]md.ts"
...
<Tabs items={['AI SDK', 'LLMGateway', 'Inkeep AI']}>
  ...
  <Tab>
    <CodeBlockTabs defaultValue="npm" groupId="package-manager">
      ...
      <CodeBlockTab value="pnpm">
        ```bash
        pnpm dlx @fumadocs/cli add ai/llmgateway
        ```
      </CodeBlockTab>

      <CodeBlockTab value="yarn">
        ```bash
        yarn dlx @fumadocs/cli add ai/llmgateway
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun x @fumadocs/cli add ai/llmgateway
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
