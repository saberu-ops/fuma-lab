...
> [查看官网](https://www.fumadocs.dev/docs/ui/layouts/docs) · [查看源文件](https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/ui/layouts/docs.mdx)
...
For page tree from [`loader()`](https://www.fumadocs.dev/docs/headless/source-api), it generates the tree from your file structure, see [available patterns](/docs/fumadocs/page-conventions).
...
You can add items by marking folders as [Root Folders](/docs/fumadocs/page-conventions#root-folder), create a `meta.json` file in the folder:
...
<Callout title="Want further customizations?">
  You can specify a `banner` to the [Docs Layout](/docs/fumadocs/ui/layouts/docs) component.
